    ...
    return(
        <div className='box-info-service'>  
            ...
            <div className="box-info-left">
                ...
                <p>
                    Whether it's guest need a ticket, save trip to rest your head,
                    Traveloka makes any type of your property simple and secure to host.
                    Get a broader exposure for your Flight and boost your occupancy
            ...
            <div className="box-info-right">
               <div>
                    ...
                    <p className='text-range'>Help your Flight day stand out by customized campaign for the right crowd and be ready for the new normal with contactless payment and in-app order.</p>
               </div>
