    ...
    return(
        <div className='box-info-service'>  
            ...
            <div className="box-info-left">
                ...
                <p>
                    Take a trip to a tropical island or dive into a coral rief,
            ...
            <div className="box-info-right">
               <div>
                    ...
                    <p className='text-range'>Help your Xperience stand out by customized campaign for the right crowd and be ready for the new normal with contactless payment and in-app order.</p>
               </div>
